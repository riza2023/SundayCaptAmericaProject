...
public class ReadExcelSheet {  //interview q:how you use it;ans:apache.poi(dependency)
	...
	public static Map<String, Map<String, String>> setMapData() throws Exception{
		...
		//we are giving path to direct to the project to make it dynamic;we use before Screenshot
		FileInputStream fis = new FileInputStream(path);
		Workbook workbook = new XSSFWorkbook(fis);  //directory of excel sheet
		Sheet sheet = workbook.getSheetAt(0);
		int lastRow = sheet.getLastRowNum();
		
		Map<String, String> dataMap = new HashMap<String, String>(); //hashmap<key, value>
	...
	public static String getMapData(String key) throws Exception{  //we are get key to return the value
		Map<String, String> m = setMapData().get("EbayDataSheet");
		String value = m.get(key);
		return value;
	}
}
//then we need to go ebaycartaction and then dropDownObj.selectByVisibleText(ReadExcelSheet.getMapData("Size"));
